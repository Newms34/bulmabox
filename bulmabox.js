...
bulmabox.alert = function (a, b, c) {
    ...
    const btns = '<button class=\'button is-info\' onclick=\'bulmabox.runCb(bulmabox.params.cb,true)\'>Okay</button>';
...
bulmabox.confirm = function (a, b, c) {
    ...
    const btns = '<button class=\'button is-success\' onclick=\'bulmabox.runCb(bulmabox.params.cb,true)\'>Okay</button><button class=\'button is-danger\' onclick=\'bulmabox.runCb(bulmabox.params.cb,false)\'>Cancel</button>';
    bulmabox.dialog(bulmabox.params.tt, bulmabox.params.ms, btns);
};
...
bulmabox.prompt = function (a, b, c) {
    ...
    const btns = '<button class=\'button is-success\' onclick=\'bulmabox.runCb(bulmabox.params.cb,document.querySelector("#bulmabox-diag-txt").value)\'>Okay</button><button class=\'button is-danger\' onclick=\'bulmabox.runCb(bulmabox.params.cb,false)\'>Cancel</button>';
    bulmabox.dialog(bulmabox.params.tt, bulmabox.params.ms, btns);
};
...
bulmabox.runCb = function (cb, data,keepAlive) {
    cb(data);
